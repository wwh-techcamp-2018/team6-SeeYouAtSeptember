...
public class ApiUserController {
    ...
    @PostMapping("")
    public ResponseEntity<Void> createNormalUser(@RequestBody UserDTO userDTO, @ApiIgnore HttpSession session) {
    ...
    @PutMapping("/chk")
    public ResponseEntity<Void> updateNormalUser(@RequestBody UserDTO userDTO, @ApiIgnore HttpSession session) {
    ...
    @PostMapping("/login")
    public ResponseEntity<UserDTO> login(@RequestBody UserDTO userDTO, @ApiIgnore HttpSession session) {
